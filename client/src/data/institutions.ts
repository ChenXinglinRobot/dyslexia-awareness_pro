...
export const hospitals: Hospital[] = [
  /* ── 国内儿童医院（前面） ── */
  {
    ...
    acceptAge: "6-16岁",
    heroImage: "/social-resource/hospital/fudan-childrens-hospital-campus.webp",
    // ── 旧字段 ──
    name: "复旦大学附属儿科医院",
    desc: "眼科开设视觉与阅读障碍专病门诊，评估视觉因素对儿童阅读困难的影响。",
    url: "https://ch.shmu.edu.cn/",
    image: "/social-resource/hospital/fudan-childrens-hospital.webp",
    logo: "/social-resource/hospital/fudan-childrens-hospital.webp",
  ...
  },
  {
    ...
    image: "/social-resource/hospital/beijing-childrens-hospital.webp",
    logo: "/social-resource/hospital/beijing-childrens-hospital.webp",
  ...
  },
  {
    ...
    acceptAge: "0-17岁",
    heroImage: "/social-resource/hospital/shenzhen-childrens-hospital-futian-campus.webp",
    // ── 旧字段 ──
    name: "深圳市儿童医院（福田院区）",
    desc: "儿童保健与心理健康中心设学习困难等门诊，提供阅读障碍评估、语言发育与读写能力训练。",
    url: "http://www.szkid.com.cn/",
    image: "/social-resource/hospital/shenzhen-childrens-hospital-futian.webp",
    logo: "/social-resource/hospital/shenzhen-childrens-hospital-futian.webp",
  ...
  },
  {
    ...
    acceptAge: "儿童及青少年",
    heroImage: "/social-resource/hospital/shanghai-childrens-medical-center-campus.webp",
    // ── 旧字段 ──
    name: "上海交通大学医学院附属上海儿童医学中心",
    desc: "临床心理科服务心理、行为问题儿童青少年，专家专长含ADHD与特定学习障碍。",
    url: "https://www.scmc.com.cn/",
    image: "/social-resource/hospital/shanghai-childrens-medical-center.webp",
    logo: "/social-resource/hospital/shanghai-childrens-medical-center.webp",
  ...
  /* ── 其他国内综合医院（中部） ── */
  {
    ...
    acceptAge: "0-16岁",
    heroImage: "/social-resource/hospital/zssy-child-development-center-campus.webp",
    // ── 旧字段 ──
    name: "中山大学附属第三医院",
    desc: "国内首个儿童发育行为障碍专业诊疗机构，评估多动症、语言发育迟缓与学习障碍。",
    url: "https://zssy.com.cn/",
    image: "/social-resource/hospital/zssy-child-development-center.webp",
    logo: "/social-resource/hospital/zssy-child-development-center.webp",
  ...
  },
  {
    ...
    acceptAge: "6-18岁",
    heroImage: "/social-resource/hospital/beijing-chaoyang-hospital-campus.webp",
    // ── 旧字段 ──
    name: "首都医科大学附属北京朝阳医院",
    desc: "临床心理科面向青少年心理、情绪与学习相关困扰提供就诊评估入口。",
    url: "https://www.bjcyh.com.cn/",
    image: "/social-resource/hospital/beijing-chaoyang-hospital.webp",
    logo: "/social-resource/hospital/beijing-chaoyang-hospital.webp",
  ...
  /* ── 精神专科医院（后面） ── */
  {
    ...
    acceptAge: "0-18岁",
    heroImage: "/social-resource/hospital/pku-sixth-hospital-campus.webp",
    // ── 旧字段 ──
    name: "北京大学第六医院",
    desc: "国内重要精神专科，儿童心理卫生中心提供学习障碍与注意缺陷多动障碍评估。",
    url: "https://www.pkuh6.cn/",
    image: "/social-resource/hospital/pku-sixth-hospital.webp",
    logo: "/social-resource/hospital/pku-sixth-hospital.webp",
  ...
  },
  {
    ...
    acceptAge: "18岁以下",
    heroImage: "/social-resource/hospital/shanghai-mental-health-center-campus.webp",
    // ── 旧字段 ──
    name: "上海市精神卫生中心",
    desc: "国家精神疾病医学中心儿少科，提供学习障碍、神经发育与心理行为问题评估。",
    url: "https://www.smhc.org.cn/",
    image: "/social-resource/hospital/shanghai-mental-health-center.webp",
    logo: "/social-resource/hospital/shanghai-mental-health-center.webp",
  ...
  /* ── 国外医院（最后） ── */
  {
    ...
    acceptAge: "1-26岁",
    heroImage: "/social-resource/hospital/child-mind-institute-campus.webp",
    // ── 旧字段 ──
    name: "Child Mind Institute",
    desc: "美国儿童心理健康领域知名非营利机构，Gund中心提供学习障碍与神经心理教育评估，覆盖阅读、书写、数学和执行功能支持。",
    url: "https://childmind.org/",
    image: "/social-resource/hospital/child-mind-institute.webp",
    logo: "/social-resource/hospital/child-mind-institute.webp",
  ...
  },
  {
    ...
    acceptAge: "7-15岁",
    heroImage: "/social-resource/hospital/boston-childrens-hospital-campus.webp",
    // ── 旧字段 ──
    name: "Boston Children's Hospital",
    desc: "哈佛医学院相关的全球大型儿科研究中心，学习障碍项目为1-8年级儿童做半日综合评估，形成诊断理解与干预计划。",
    url: "https://www.childrenshospital.org/",
    image: "/social-resource/hospital/boston-childrens-hospital.webp",
    logo: "/social-resource/hospital/boston-childrens-hospital.webp",
  ...
  },
  {
    ...
    acceptAge: "婴儿至18岁",
    heroImage: "/social-resource/hospital/mayo-clinic-campus.webp",
    // ── 旧字段 ──
    name: "Mayo Clinic（梅奥诊所）",
    desc: "梅奥诊所是全球知名的非营利综合医疗机构，儿童中心发育行为儿科评估学习与社交发展问题，提供多学科发展、学业与行为测试。",
    url: "https://www.mayoclinic.org/",
    image: "/social-resource/hospital/mayo-clinic.webp",
    logo: "/social-resource/hospital/mayo-clinic.webp",
...
export const researchInstitutes: ResearchInstitute[] = [
  {
    ...
    heroImage: "/social-resource/institute/bnu-learning-lab-campus.webp",
    // ── 旧字段 ──
    name: "北京师范大学",
    desc: "研究汉语阅读发展、可读性与互联网干预，为早期识别和阅读训练提供证据。",
    url: "https://psych.bnu.edu.cn/szdw/zrjs/js/lh/index.htm",
    image: "/social-resource/institute/bnu-learning-lab.webp",
    logo: "/social-resource/institute/bnu-learning-lab.webp",
  ...
  },
  {
    ...
    heroImage: "/social-resource/institute/pku-meng-lab-campus.webp",
    // ── 旧字段 ──
    name: "北京大学",
    desc: "研究视觉注意和神经可塑性，比较中英文阅读障碍，为儿童评估和干预提供线索。",
    url: "https://www.psy.pku.edu.cn/szdw/qzjy/fjs/mxz/index.htm",
    image: "/social-resource/institute/pku-meng-lab.webp",
    logo: "/social-resource/institute/pku-meng-lab.webp",
  ...
  },
  {
    ...
    heroImage: "/social-resource/institute/cas-psychology-bi-campus.webp",
    // ── 旧字段 ──
    name: "中国科学院心理研究所",
    desc: "研究汉字认知、视觉与听觉加工机制，为中文阅读障碍识别和干预提供依据。",
    url: "https://psych.cas.cn/sourcedb/cn/expert/200908/t20090826_6369803.html",
    image: "/social-resource/institute/cas-psychology-bi.webp",
    logo: "/social-resource/institute/cas-psychology-bi.webp",
  ...
  },
  {
    ...
    heroImage: "/social-resource/institute/ntnu-lee-team-campus.webp",
    // ── 旧字段 ──
    name: "台湾师范大学",
    ...
    image: "/social-resource/institute/ntnu-lee-team.webp",
    logo: "/social-resource/institute/ntnu-lee-team.webp",
  ...
  },
  {
    ...
    heroImage: "/social-resource/institute/cuhk-mcbride-team-campus.webp",
    // ── 旧字段 ──
    name: "香港中文大学",
    desc: "研究跨文化读写发展与语素意识，长期追踪儿童阅读风险和早期支持路径。",
    url: "https://www.psy.cuhk.edu.hk/images/FacultyMembersInfo/cammiecv20191217.pdf",
    image: "/social-resource/institute/cuhk-mcbride-team.webp",
    logo: "/social-resource/institute/cuhk-mcbride-team.webp",
  ...
  },
  {
    ...
    image: "/social-resource/institute/harvard-gaab-lab.webp",
    logo: "/social-resource/institute/harvard-gaab-lab.webp",
  ...
  },
  {
    ...
    image: "/social-resource/institute/yale-dyslexia-center.webp",
    logo: "/social-resource/institute/yale-dyslexia-center.webp",
  ...
  },
  {
    ...
    focusAreas: ["认知多样", "筛查评估", "干预研究", "多学科合作"],
    institutionDesc: "依托加州大学旧金山分校的医学与神经科学基础，以及伯克利分校的综合研究优势，两校联合建设施瓦布读写障碍与认知多样性中心。",
    heroImage: "/social-resource/institute/ucsf-ucb-schwab-center-campus.webp",
    // ── 旧字段 ──
    name: "UCSF | UC Berkeley",
    desc: "整合医学、神经科学、心理学、教育与公共卫生资源，推动读写障碍筛查评估、干预研究与去污名化。",
    url: "https://schwabcognitivediversity.ucsf.edu/",
    image: "/social-resource/institute/ucsf-ucb-schwab-center.webp",
    logo: "/social-resource/institute/ucsf-ucb-schwab-center.webp",
  ...
  },
  {
    ...
    focusAreas: ["神经科学", "早期筛查", "学校合作", "教学支持"],
    institutionDesc: "加州大学旧金山分校读写障碍中心依托 UCSF 的医学、神经科学与教育转化研究基础，推进读写障碍研究、早期识别与学校合作。",
    heroImage: "/social-resource/institute/ucsf-dyslexia-center-campus.webp",
    // ── 旧字段 ──
    name: "UCSF Dyslexia Center",
    desc: "开发 Multitudes 数字筛查平台，支持 K-2 儿童阅读困难风险识别、结果报告与教学支持。",
    url: "https://multitudesinfo.ucsf.edu/",
    image: "/social-resource/institute/ucsf-dyslexia-center.webp",
    logo: "/social-resource/institute/ucsf-dyslexia-center.webp",
