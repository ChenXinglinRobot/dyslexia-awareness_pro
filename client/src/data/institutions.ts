...
export const hospitals: Hospital[] = [
  ...
  },
  {
    ...
    image: "/social-resource/hospital/shenzhen-childrens-hospital-longhua.png",
    logo: "/social-resource/hospital/shenzhen-childrens-hospital-longhua.png",
    logoFallback: "https://picsum.photos/seed/shenzhen-childrens-hospital-longhua/800/800",
  },
  {
...
export const researchInstitutes: ResearchInstitute[] = [
  ...
  },
  {
    ...
    focusAreas: ["声韵觉识", "识字评估", "认知成分", "中文断词"],
    // ── 旧字段 ──
    name: "台湾师范大学",
  ...
  },
  {
    ...
    focusAreas: ["脑发育", "MRI影像", "早期筛查", "读写发展"],
    // ── 旧字段 ──
  ...
  },
  {
    ...
    focusAreas: ["优势模型", "流行病学", "筛查工具", "政策倡导"],
    // ── 旧字段 ──
