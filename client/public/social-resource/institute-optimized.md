...
institutes:
  ...
  - rank: 8
    ...
    counts: "name 15/30, desc 29/80, dyslexiaLab 23/35, focusAreas 4项；单项最大 4/8"
  ...
  - rank: 9
    ...
    representativePapers: []
    counts: "name 18/30, desc 31/80, dyslexiaLab 18/35, focusAreas 4项；单项最大 4/8"
```
...
【改版】name: UCSF 与 UC Berkeley；dyslexiaLab: Schwab Center for Dyslexia；focusAreas: 认知多样、数字筛查、临床表型、早期识别；desc: 研究认知多样性、数字筛查与临床表型，推动儿童阅读困难的早期识别。

【字数】name: 15/30，desc: 29/80，dyslexiaLab: 23/35，focusAreas: 4 项，单项最大 4/8

【改动说明】原机构名为英文缩写且完整英文名称会超过 `name` 上限，因此保留短名，并在 `officialName` 中补充完整英文机构名；实验室名删去后半段 “and Cognitive Diversity”，但在描述中保留“认知多样性”。
...
【改版】name: UCSF Dyslexia Center；dyslexiaLab: Multitudes 早期识字筛查平台；focusAreas: 神经影像、风险算法、识字筛查、学校应用；desc: 结合神经病学、影像和数字算法，开发早期识字筛查工具，服务学校风险识别。

【字数】name: 18/30，desc: 31/80，dyslexiaLab: 18/35，focusAreas: 4 项，单项最大 4/8

【改动说明】原始标签过长且包含多个科研方向，按网页展示需求保留与阅读障碍最直接相关的神经影像、风险算法和识字筛查；将 Mission Bay 校区信息从城市字段中移除，避免卡片信息过载。
